...
// TOKEN
const TOKEN = "";
...
app.post("/webhook", async (req, res) => {
  try {
    ...
    if (message.text) {
      ...
      await sendText(
        from,
        "No entendí 😅\nEscriba *una letra* o una de estas opciones:\n" +
